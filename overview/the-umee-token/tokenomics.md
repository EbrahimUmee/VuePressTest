...
{% tab title="Inflation & Deflation Mechanisms" %}
## Inflation
...
{% hint style="success" %}
_**The dynamic inflation rate and the staking mechanism of the Umee blockchain is the ultimate security mechanism that guarantees the security of the Umee network.**_
{% endhint %}
...
Of the platform fees generated by the initial borrowing and lending functionality, <mark style="color:blue;"></mark> [<mark style="color:blue;">community governance</mark>](../governance/) can make decisions regarding buybacks and burns of UMEE tokens. Additional deflation of the token supply will occur via governance determined mechanisms.
...
{% tab title="Distribution & Release Schedule" %}
## Distribution & Release Schedule

![UMEE Token Genesis Distribution](<../../.gitbook/assets/image (12).png>)

![UMEE Token Release Schedule](<../../.gitbook/assets/image (29).png>)
